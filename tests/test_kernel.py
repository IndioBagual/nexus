...
class MockRepo:
    def add(self, item): return 1
    def save(self, item): return "path/file.md"
    def log_xp(self, a, b, c, d): pass

class MockCortex:
    def parse_intent(self, text):
        return [{"action": "add_expense", "params": {"amount": 10, "category": "Food", "description": "Test"}}]
